export function createWelcomeEmailTemplate(name, clientURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #36D1DC, #5B86E5); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
      ...
      <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 500;">欢迎使用 Messenger!</h1>
    </div>
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #5B86E5;"><strong>Hello ${name},</strong></p>
      <p>我们很高兴你加入我们的即时通讯平台! 无论朋友、家人和同事身在何处, Messenger都能让您与他们实时联系。</p>
      
      <div style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #36D1DC;">
        <p style="font-size: 16px; margin: 0 0 15px 0;"><strong>只需几步即可开始:</strong></p>
        <ul style="padding-left: 20px; margin: 0;">
          <li style="margin-bottom: 10px;">设置您的个人资料图片</li>
          <li style="margin-bottom: 10px;">查找并添加您的联系人</li>
          <li style="margin-bottom: 10px;">开始对话</li>
          <li style="margin-bottom: 0;">分享照片、视频等</li>
        </ul>
      </div>
      ...
      <p style="margin-bottom: 5px;">如果您需要任何帮助或有任何疑问，我们随时为您提供协助。</p>
      <p style="margin-top: 0;">Happy messaging!</p>
      
      <p style="margin-top: 25px; margin-bottom: 0;">此致敬礼,<br>The Messenger Team</p>
    </div>
